...
//
// The text in this code uses material from the Wikipedia articles https://en.wikipedia.org/wiki/Auckland, https://en.wikipedia.org/wiki/Wellington, https://en.wikipedia.org/wiki/Christchurch, https://en.wikipedia.org/wiki/Dunedin, https://en.wikipedia.org/wiki/Hamilton,_New_Zealand, which are released under the Creative Commons Attribution-Share-Alike License 3.0 (https://creativecommons.org/licenses/by-sa/3.0/).
//
