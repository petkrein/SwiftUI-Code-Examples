                ...
                ForEach(0..<list.count) { index in
                    DynamicHeightTextField(
                        text: Binding(
                            ...
                            set: {
                                self.list[index].text = $0
                            }
                        ),
                        height: Binding(
                            get: {
                                self.list[index].textFieldHeight
                            },
                            set: {
                                self.list[index].textFieldHeight = $0
                            }
                        )
                    )
                    .frame(height: self.list[index].textFieldHeight)
                }
            }
        }
    }
